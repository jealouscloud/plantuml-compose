...
d.add(n.node("Central Topic",
    n.node("Left Branch 1", side="left",
        n.leaf("Item A"),
    ),
    n.node("Left Branch 2", side="left",
        n.leaf("Item B"),
    ),
))
...
d.add(n.node("Central Topic",
    n.node("Right Branch 1", side="right",
        n.leaf("Item A"),
    ),
    n.node("Right Branch 2", side="right",
        n.leaf("Item B"),
    ),
))
...
d.add(n.node("Pros and Cons",
    n.node("Pros", side="right",
        n.leaf("Fast"),
        n.leaf("Reliable"),
        n.leaf("Affordable"),
    ),
    n.node("Cons", side="left",
...
d.add(n.node("Topic", color="LightBlue",
    n.leaf("Normal child"),
...
d.add(n.node("Colors", color="#E3F2FD",
...
d.add(n.node("Website Redesign",
    n.node("Research", side="left",
        n.leaf("User interviews"),
        n.leaf("Competitor analysis"),
        n.leaf("Analytics review"),
    ),
    n.node("Design", side="left",
        n.leaf("Wireframes"),
        n.leaf("Mockups"),
        n.leaf("Prototype"),
    ),
    n.node("Development", side="right",
        n.leaf("Frontend"),
        n.leaf("Backend"),
        n.leaf("Database"),
    ),
    n.node("Launch", side="right",
        n.leaf("Testing"),
        n.leaf("Deployment"),
        n.leaf("Monitoring"),
    ),
